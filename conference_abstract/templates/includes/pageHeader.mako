					...
					<div class="container">
						<div class="pull-left">
							<ul class="navbar-top-nav clearfix hidden-xs">
								...
								<li role="presentation"><a role="menuitem" tabindex="-1" href="/"><i class="fa fa-home"></i>Home</a></li>
									% if user.is_admin():
								<li role="presentation"><a role="menuitem" tabindex="-1" href="/dashboard"><i class="fa fa-user"></i>Submitted Abstracts</a></li>
									% elif user.is_reviewer():
								<li role="presentation"><a role="menuitem" tabindex="-1" href="/dashboard"><i class="fa fa-user"></i>Assigned Abstracts</a></li>
									% else:
								<li role="presentation"><a role="menuitem" tabindex="-1" href="/dashboard"><i class="fa fa-user"></i>My Abstracts</a></li>
									% endif
