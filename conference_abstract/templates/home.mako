...
<%include file="includes/contentHeader.mako"/>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p>Abstract submission opens on 31 January 2017 and closed on 28 April 2017.  Please create an abstract submission account and login to submit your abstract(s) for oral or poster presentations. Please note - this is not a conference registration!</p>
			% if user is UNDEFINED or user is None:
			<div class="callout bordered" style="margin-bottom:10px">
				...
				<div class="callout-wrapper">
					<div class="callout-right text-left">
						...
						<p class="callout-desc">Abstract management is restricted to Reviewers and Conference Coordinators</p>
			...
			## add if to hide the poster submission at beginning of conference
			<div class="callout bordered">
				<span class="callout-icon reverse"></span>
				<div class="callout-wrapper">
					<div class="callout-right text-left">
						<h2 class="callout-title">Poster Submission Portal is now closed</h2>
						<p class="callout-desc"></p>
					</div><!-- End .callout-right -->
					 <div class="callout-right">
						<!--<input type="button" class="btn btn-custom" value="Upload Poster" onclick="location.href='/loginPoster'">-->
					</div><!-- End .callout-left -->
				</div><!-- End .callout-wrapper -->
			</div><!-- End .callout -->
			% else:
			...
			<div class="callout bordered">
				...
				<div class="callout-wrapper">
					<div class="callout-right text-left">
						<h2 class="callout-title">Poster Submission Portals</h2>
						<p class="callout-desc"></p>
					</div><!-- End .callout-right -->
					 <div class="callout-right">
						<input type="button" class="btn btn-custom" value="Upload Poster" onclick="location.href='/loginPoster'">
