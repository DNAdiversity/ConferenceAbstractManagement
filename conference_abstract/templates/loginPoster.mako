					...
					<div class="row">
						<div class="col-sm-6 col-sm-push-3 col-lg-4 col-lg-push-4">
							...
							<div class="form-wrapper">
								...
								<h2 class="title-underblock custom mb30">Poster Submission Portal</h2>
								<p>Poster Submission is now closed</p>
								% else:
								<h2 class="title-underblock custom mb30">Poster Submission Portal</h2>
								<p>Poster Submission is now closed</p>
								% endif
								...
								<!--<form method="post">
									...
									<div class="row">
										<!--<input type="submit" name="submit" class="btn btn-custom" value="Login Now">-->
										##<br><br><hr><br>
