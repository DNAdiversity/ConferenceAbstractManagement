	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#email").on("blur",function(){
				...
				$.ajax({
					...
					if(data["success"] == false){
						...
						validEmail = false;
						swal("Oops...", "Please choose another group name", "error");
						$(".sweet-alert fieldset input[type='text']").css("display","none");
					}
				});
			});
			...
			function validateSubmit(){
				...
				if (validEmail == false){
					validSubmit = false;
					errors[errors.length] = "That email has already been registered. Please use another one."
				}
		...
		<div class="col-sm-12">
			...
			<form id="formRegister" action="#" method="post" onsubmit="">
				<div class="row">
					...
					<div class="col-sm-1">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="middleinitial" name="middleinitial" placeholder="Initial">
						</div><!-- End .from-group -->
					</div><!-- End .col-sm-1 -->
					<div class="col-sm-6 ">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-6 ">
						<div class="form-group">
							<label for="institution" class="input-desc">Institution</label>
