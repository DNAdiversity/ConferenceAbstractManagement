	...
	<div class="row">
		...
		<img src="../static/images/progess.png" class="img-responsive" alt="" />		
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<input type="radio" class="preferredPresentation" name="abstractType" value="Talk"  required> Talk&nbsp;&nbsp;<i class="fa fa-microphone first-color"></i>
					</div>
					<div class="col-sm-2">
						<input type="radio" class="preferredPresentation" name="abstractType" value="Poster"  required> Poster&nbsp;&nbsp;<i class="fa fa-file-text-o first-color"></i>
					</div>
					<div class="col-sm-8">
						<input type="radio" class="preferredPresentation" name="abstractType" value="Lightning Talk" required> Lightning Talk&nbsp;&nbsp;<i class="fa fa-bolt first-color"></i> <small>(5 min presentation plus poster)</small>
					</div>			
				</div><!-- End .row -->
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<h5>Title</h5>
							<input type="text" class="form-control" maxlength="1000" id="abstractTitle" name="abstractTitle" placeholder="Abstract Title" value="" required>
						</div><!-- End .from-group -->
					</div><!-- End .col-sm-12 -->
				</div><!-- End .row -->
				...
				<div class="row">
					<div class="col-sm-12 ">
						<div class="form-group">
							<h5>Abstract</h5>
							<textarea class="form-control" id="abstractText" rows="10" name="abstractText" placeholder="Abstract Text" required></textarea>
				...
				<div class="row">
					% for i in range(len(categoryNames)):
						<div class="col-md-4 col-sm-6">
							...
							<div class="checkbox">
								<label><input type="checkbox" class="category" name="category[]" value="'${categories[i][j]['label']|n}'">${categories[i][j]['label']|n}</label>
							</div>
							% endfor
						</div>
						% if (i+1)%3 == 0 and i>0:
				...
				<div class="hidden">
					<table>
						...
						<tr id="authorRow2">
							...
							<td>
								<label><input type="checkbox" id="presentingCheck" title="Presenting" class=" value="t"><input type="hidden" id="presenting" name="presenting[]" value="f"> P</label>
							</td>
							<td>
								<label><input type="checkbox" class="corresponding" title="Corresponding" id="correspondingCheck" value="t"><input type="hidden" id="corresponding" name="corresponding[]" value="f"> C</label>
							</td>
						</tr>
					</table>
				</div><!-- End Hidden -->
