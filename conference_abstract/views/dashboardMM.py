...
service = Service(name='dashboardMM', path='/dashboardMM', description=info_desc)
...
def service_get(request):
    ...
    return conference_abstract.util.generate_template('dashboardMM.mako',templateVars)
